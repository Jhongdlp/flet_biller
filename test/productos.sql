-- Tecnología
INSERT INTO productos (ID_PROD, NOM_PROD, TIP_PROD, TIP_ESP_PROD, MAR_PRO, PROVE_PRO, IVA_PRO, PRE_PRO, EXIS_PRO) 
VALUES
(1, 'Laptop ultrafina', 'Tecnologia', 'Laptop', 'Dell', 'Tech Solutions', 15, 1200.00, 50),
(2, 'Smartphone avanzado', 'Tecnologia', 'Smartphone', 'Samsung', 'Electronics Plus', 15, 899.99, 80),
(3, 'Tablet profesional', 'Tecnologia', 'Tablet', 'Apple', 'Hi-Tech Suppliers', 15, 799.50, 60),
(4, 'Cámara digital 4K', 'Tecnologia', 'Camara digital', 'Canon', 'Gadget World', 15, 699.00, 70),
...
(7, 'Impresora láser multifuncional', 'Tecnologia', 'Impresora', 'HP', 'Print Solutions', 15, 299.50, 55),
(8, 'Teclado mecánico RGB', 'Tecnologia', 'Teclado', 'Logitech', 'Gaming Gear', 15, 129.00, 75),
(9, 'Mouse gamer inalámbrico', 'Tecnologia', 'Mouse', 'Razer', 'Gaming Gear', 15, 79.99, 85),
(10, 'Router Wi-Fi 6 de doble banda', 'Tecnologia', 'Router', 'TP-Link', 'Network Solutions', 15, 149.50, 65),
(11, 'Disco duro externo 2TB', 'Tecnologia', 'Disco duro', 'Seagate', 'Storage Solutions', 15, 129.99, 50),
(12, 'Smart TV 55" 4K HDR', 'Tecnologia', 'Smart TV', 'LG', 'Home Electronics', 15, 799.00, 30),
...
(15, 'Auriculares con cancelación de ruido', 'Tecnologia', 'Auriculares', 'Bose', 'Audio Systems', 15, 299.00, 60),
(16, 'Proyector Full HD 1080p', 'Tecnologia', 'Proyector', 'Epson', 'Visual Solutions', 15, 699.50, 25),
(17, 'Drone con cámara 4K', 'Tecnologia', 'Drone', 'DJI', 'Aerial Systems', 15, 899.00, 35),
(18, 'Robot aspirador inteligente', 'Tecnologia', 'Robot aspirador', 'iRobot', 'Home Solutions', 15, 349.99, 55),
(19, 'Estación de carga USB multiport', 'Tecnologia', 'Estación de carga', 'Belkin', 'Power Solutions', 15, 59.50, 70),
(20, 'Smartwatch resistente al agua', 'Tecnologia', 'Smartwatch', 'Garmin', 'Wearable Tech', 15, 199.00, 80);

-- Higiene
INSERT INTO productos (ID_PROD, NOM_PROD, TIP_PROD, TIP_ESP_PROD, MAR_PRO, PROVE_PRO, IVA_PRO, PRE_PRO, EXIS_PRO) 
VALUES
(21, 'Champú revitalizante', 'Higiene', 'Champu', 'Pantene', 'Beauty Distributors', 15, 8.99, 100),
(22, 'Jabón líquido antibacterial', 'Higiene', 'Jabon', 'Dove', 'Hygiene Co.', 15, 4.50, 120),
...
(27, 'Toallas de papel absorción máxima', 'Higiene', 'Toallas de papel', 'Scott', 'Paper Products', 15, 2.50, 150),
...
(30, 'Cepillo para el cabello desenredante', 'Higiene', 'Cepillo para el cabello', 'Tangle Teezer', 'Hair Care Ltd.', 15, 12.50, 100),
(31, 'Gel antibacterial 500ml', 'Higiene', 'Gel antibacterial', 'Purell', 'Hygiene Solutions', 15, 6.50, 120),
...
(36, 'Toallitas desmaquillantes', 'Higiene', 'Toallitas desmaquillantes', 'Neutrogena', 'Skin Care Ltd.', 15, 4.75, 110),
(37, 'Bálsamo labial protector SPF 15', 'Higiene', 'Bálsamo labial', 'Carmex', 'Lip Care Co.', 15, 1.99, 190),
(38, 'Pasta dental blanqueadora', 'Higiene', 'Pasta dental', 'Colgate', 'Oral Care Co.', 15, 3.50, 130),
...
INSERT INTO productos (ID_PROD, NOM_PROD, TIP_PROD, TIP_ESP_PROD, MAR_PRO, PROVE_PRO, IVA_PRO, PRE_PRO, EXIS_PRO) 
VALUES
(41, 'Sneakers deportivos', 'Ropa', 'Sneakers', 'Nike', 'Sport Gear Inc.', 15, 120.00, 60),
(42, 'Bufanda de lana', 'Ropa', 'Bufanda', 'Burberry', 'Fashion Trends', 15, 55.75, 40),
(43, 'Gorra ajustable', 'Ropa', 'Gorra', 'New Era', 'Headwear Masters', 15, 25.50, 50),
...
(47, 'Camisa de algodón manga larga', 'Ropa', 'Camisa', 'Tommy Hilfiger', 'Designer Apparel', 15, 69.50, 45),
...
(50, 'Zapatos formales cuero', 'Ropa', 'Zapatos', 'Clarks', 'Footwear Experts', 15, 99.50, 20),
(51, 'Sombrero de ala ancha', 'Ropa', 'Sombrero', 'Goorin Bros', 'Headwear Masters', 15, 45.00, 15),
...
(54, 'Bufanda de seda pura', 'Ropa', 'Bufanda', 'Hermès', 'Luxury Accessories', 15, 199.00, 10),
(55, 'Guantes de cuero premium', 'Ropa', 'Guantes', 'Ralph Lauren', 'Designer Apparel', 15, 79.50, 25),
...
(58, 'Pantalón deportivo running', 'Ropa', 'Pantalón deportivo', 'Adidas', 'Sport Gear Inc.', 15, 49.50, 40),
...
INSERT INTO productos (ID_PROD, NOM_PROD, TIP_PROD, TIP_ESP_PROD, MAR_PRO, PROVE_PRO, IVA_PRO, PRE_PRO, EXIS_PRO) 
VALUES
(61, 'Taladro percutor', 'Herramientas', 'Taladro', 'Bosch', 'Tool Masters', 15, 120.00, 60),
...
(64, 'Sierra circular portátil', 'Herramientas', 'Sierra circular', 'Dewalt', 'Cutting Edge Tools', 15, 180.00, 30),
(65, 'Lijadora orbital', 'Herramientas', 'Lijadora', 'Black+Decker', 'Sanders Inc.', 15, 65.50, 25),
(66, 'Martillo de carpintero', 'Herramientas', 'Martillo', 'Estwing', 'Tool Masters', 15, 29.99, 55),
(67, 'Alicate de corte profesional', 'Herramientas', 'Alicate', 'Klein Tools', 'Hardware Solutions', 15, 24.50, 65),
...
(70, 'Pistola de calor profesional', 'Herramientas', 'Pistola de calor', 'Milwaukee', 'Heat Tools', 15, 89.50, 35),
...
(74, 'Generador eléctrico portátil 3000W', 'Herramientas', 'Generador eléctrico', 'Honda', 'Power Solutions', 15, 699.00, 20),
(75, 'Taladro inalámbrico 20V', 'Herramientas', 'Taladro', 'Makita', 'Cordless Tools', 15, 179.50, 40),
(76, 'Sierra de calar pendular', 'Herramientas', 'Sierra de calar', 'Bosch', 'Cutting Edge Tools', 15, 129.00, 30),
...
(80, 'Detector de voltaje sin contacto', 'Herramientas', 'Detector de voltaje', 'Klein Tools', 'Electrical Tools', 15, 19.50, 50);

-- Alimentos
INSERT INTO productos (ID_PROD, NOM_PROD, TIP_PROD, TIP_ESP_PROD, MAR_PRO, PROVE_PRO, IVA_PRO, PRE_PRO, EXIS_PRO) 
VALUES
(81, 'Arroz blanco 5kg', 'Alimentos', 'Arroz', 'Molinos', 'Grain Suppliers', 15, 10.50, 100),
...
(84, 'Pasta spaghetti integral', 'Alimentos', 'Pasta', 'Barilla', 'Pasta Experts', 15, 2.50, 110),
...
(87, 'Chocolate negro 70% cacao', 'Alimentos', 'Chocolate', 'Ghirardelli', 'Chocolates Inc.', 15, 4.50, 150),
...
(90, 'Salsa de tomate italiana', 'Alimentos', 'Salsa de tomate', 'Rao''s', 'Pasta Sauce Co.', 15, 5.50, 160),
...
(94, 'Té verde matcha en polvo', 'Alimentos', 'Te', 'Matcha Love', 'Tea Suppliers', 15, 12.50, 100),
...
(99, 'Caramelos de menta sin azúcar', 'Alimentos', 'Caramelos', 'Altoids', 'Candy Co.', 15, 1.50, 240),
